                    ...
                    {isSuccess ? (
                        <div className="p-12 text-center">
                            ...
                            <h2 className="text-2xl font-black text-gray-900 mb-2">
                                Session Booking Request submitted !
                            </h2>
                            <p className="text-gray-500">
                                Your session with {mentorName} has been
                                ...
                                <div className="flex flex-col gap-4">
                                    ...
                                    <div className="flex items-start gap-2 bg-blue-50/50 p-4 rounded-2xl">
                                        ...
                                        <p className="text-[10px] text-blue-600 font-medium leading-relaxed">
                                            ...
                                            3-hour reschedule policy.
                                            Cancellation within 3 hours of the
                                            session may result in a lost
                                            session.
                                        </p>
                                    </div>
                                </div>
