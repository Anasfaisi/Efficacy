...
const MyMentorshipsPage: React.FC = () => {
    ...
    const filteredMentorships = mentorships.filter((m) => {
        ...
        if (filter === 'Active')
            return [MentorshipStatus.ACTIVE, MentorshipStatus.COMPLETED].includes(
                m.status
            );
        if (filter === 'Rejected')
            return [MentorshipStatus.REJECTED, MentorshipStatus.CANCELLED].includes(
                m.status
            );
        return true;
    });
                        ...
                        <header className="mb-8">
                            ...
                            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                                ...
                                <div className="flex bg-white p-1 rounded-xl border border-gray-200 shadow-sm">
                                    {['All', 'Requests', 'Active', 'Rejected'].map((f) => (
                                        <button
                                            key={f}
                                            onClick={() => {
                                                setFilter(f);
                                                    ...
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-xs text-gray-500 flex items-center gap-1">
                                                                <Briefcase size={12} />
                                                                {mentorship.mentorId?.expertise || 'Expert'}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="space-y-3 mb-6">
                                                    ...
                                                    <div className="flex justify-between items-center text-sm">
                                                        ...
                                                        <span className="font-medium text-gray-900">
                                                            {mentorship.usedSessions} / {mentorship.totalSessions}
                                                        </span>
                                                    </div>
                                                ...
                                                <div className="pt-4 border-t border-gray-50 flex items-center justify-between text-[#7F00FF] font-medium text-sm group-hover:translate-x-1 transition-transform">
                                                    <div className="flex gap-4">
                                                        ...
                                                        {mentorship.status === MentorshipStatus.ACTIVE && (
                                                            <button
                                                                onClick={(e) => handleCancel(e, mentorship._id)}
