    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                console.log(mentorData,"mentordata  ... ",reviewsData,"reviewsData ... ")
    ...
    const mentorshipPoints = [
        {
            ...
            content: "Support for career, job applications, and emotional well-being.",
            icon: <HeartHandshake className="w-5 h-5" />
        },
        {
            title: "Flexible Schedule",
            content: "10 regular sessions per month conducted on alternative days.",
            icon: <Clock className="w-5 h-5" />
        },
        {
            title: "Call Preference",
            content: "Your choice of high-quality Video or Audio call sessions.",
            icon: <Globe className="w-5 h-5" />
        },
        {
            title: "Easy Rescheduling",
            content: "Request changes up to 6 hours before your scheduled session.",
                            ...
                            <div className="lg:col-span-1 space-y-6 lg:sticky lg:top-8">
                                <div className="bg-white rounded-[2.5rem] p-8 shadow-xl shadow-gray-200/50 border border-gray-100 flex flex-col items-center text-center">
                                    <div className="relative mb-6">
                                        ...
                                        <img 
                                            src={mentor.profilePic || `https://ui-avatars.com/api/?name=${encodeURIComponent(mentor.name)}&background=7F00FF&color=fff&size=200`}
                                            alt={mentor.name}
                                            className="relative w-40 h-40 rounded-[2rem] object-cover border-4 border-white shadow-lg"
                                        />
                                        {(mentor.isVerified || reviews.length === 0) && (
                                            <div className={`absolute -bottom-2 -right-2 ${reviews.length === 0 ? 'bg-amber-500' : 'bg-green-500'} text-white px-3 py-1 rounded-full border-4 border-white shadow-lg text-[10px] font-black uppercase tracking-wider`}>
                                                {reviews.length === 0 ? 'New Talent' : 'Verified'}
                                            </div>
                                        )}
                                    </div>

                                    <h1 className="text-2xl font-black text-gray-900 mb-1">{mentor.name}</h1>
                                    <p className="text-[#7F00FF] font-bold text-sm mb-4 uppercase tracking-wider">
                                        {mentor.currentRole || mentor.domain || 'Mentor'}
                                    </p>
                                    ...
                                    <div className="flex items-center gap-6 mb-8 w-full justify-center">
                                        ...
                                        <div className="w-px h-10 bg-gray-100" />
                                        <div className="text-center">
                                            <p className="text-xl font-black text-gray-900">{mentor.sessionsCompleted || 0}</p>
                                            <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Sessions</p>
                                        </div>
                                    </div>

                                    <div className="w-full space-y-4 pt-6 border-t border-gray-50">
                                        <div className="flex flex-col gap-1 items-start">
                                            <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Proposed Start Date</span>
                                            <input
                                                type="date"
                                        ...
                                        >
                                            {isBooking ? 'Processing...' : 'Book Mentorship'}
                                            <Calendar size={18} />
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white rounded-[2.5rem] p-8 shadow-xl shadow-gray-200/50 border border-gray-100">
                                    <h3 className="text-lg font-black text-gray-900 tracking-tight mb-6">Mentorship Plan</h3>
                                    <div className="space-y-6">
                                        {mentorshipPoints.map((point, idx) => (
                                            <div key={idx} className="flex gap-4">
                                                ...
                                                <div>
                                                    <p className="text-sm font-black text-gray-900 mb-0.5">{point.title}</p>
                                                    <p className="text-xs text-gray-500 font-medium leading-relaxed">{point.content}</p>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                                ...
                                <div className="bg-white rounded-[2rem] p-8 shadow-xl shadow-gray-200/50 border border-gray-100 space-y-6">
                                    <h3 className="text-lg font-black text-gray-900 tracking-tight">Connect</h3>
                                    <div className="space-y-4">
                                        {mentor.linkedin && (
                                            <a href={mentor.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-600 hover:text-[#0077B5] transition-colors font-medium">
                                        ...
                                        {mentor.github && (
                                            <a href={mentor.github} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-600 hover:text-black transition-colors font-medium">
                            ...
                            <div className="lg:col-span-2 space-y-8">
                                ...
                                <section className="bg-white rounded-[2.5rem] p-10 shadow-xl shadow-gray-200/50 border border-gray-100 relative overflow-hidden">
                                    <div className="absolute top-0 right-0 p-8 opacity-5">
                                        <Quote size={120} className="text-[#7F00FF]" />
                                    </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <section className="bg-white rounded-[2.5rem] p-8 shadow-xl shadow-gray-200/50 border border-gray-100">
                                        <h3 className="text-xl font-black text-gray-900 mb-6 flex items-center gap-3">
                                            <Briefcase size={22} className="text-[#7F00FF]" />
                                            Experience
                                        </h3>
                                        <div className="space-y-6">
                                            <div>
                                                <p className="text-xs font-black text-gray-400 uppercase tracking-widest mb-1">Current Role</p>
                                                <p className="font-bold text-gray-800">{mentor.currentRole || 'N/A'}</p>
                                            </div>
                                            <div>
                                                <p className="text-xs font-black text-gray-400 uppercase tracking-widest mb-1">Domain</p>
                                                <p className="font-bold text-gray-800">{mentor.domain || 'N/A'}</p>
                                            </div>
                                            <div>
                                                <p className="text-xs font-black text-gray-400 uppercase tracking-widest mb-1">Experience</p>
                                                <p className="font-bold text-gray-800">{mentor.experienceYears || '0'}+ Years</p>
                                            </div>
                                        </div>
                                    </section>
                                    ...
                                    <section className="bg-white rounded-[2.5rem] p-8 shadow-xl shadow-gray-200/50 border border-gray-100">
                                        <h3 className="text-xl font-black text-gray-900 mb-6 flex items-center gap-3">
                                            <GraduationCap size={22} className="text-[#7F00FF]" />
                                            Education
                                        </h3>
                                        <div className="space-y-6">
                                            <div>
                                                <p className="text-xs font-black text-gray-400 uppercase tracking-widest mb-1">Degree</p>
                                                <p className="font-bold text-gray-800">{mentor.qualification || 'N/A'}</p>
                                            </div>
                                            <div>
                                                <p className="text-xs font-black text-gray-400 uppercase tracking-widest mb-1">University</p>
                                                <p className="font-bold text-gray-800">{mentor.university || 'N/A'}</p>
                                            </div>
                                            <div>
                                                <p className="text-xs font-black text-gray-400 uppercase tracking-widest mb-1">Class Of</p>
                                                <p className="font-bold text-gray-800">{mentor.graduationYear || 'N/A'}</p>
                                            </div>
                                        </div>
                                    </section>
                                </div>
                                ...
                                <section className="bg-white rounded-[2.5rem] p-10 shadow-xl shadow-gray-200/50 border border-gray-100">
                                    <h3 className="text-xl font-black text-gray-900 mb-6">Expertise & Skills</h3>
                                ...
                                {guidanceAreas.length > 0 && (
                                    <section className="bg-white rounded-[2.5rem] p-10 shadow-xl shadow-gray-200/50 border border-gray-100">
                                        <h3 className="text-xl font-black text-gray-900 mb-6">How I can guide you</h3>
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            {guidanceAreas.map((area, i) => (
                                                <div key={i} className="flex items-center gap-3 p-4 bg-gray-50/50 rounded-2xl group transition-all duration-300 border border-transparent hover:border-[#7F00FF]/10">
                                ...
                                <section className="bg-white rounded-[2.5rem] p-10 shadow-xl shadow-gray-200/50 border border-gray-100">
                                    <h3 className="text-xl font-black text-gray-900 mb-6 flex items-center gap-3">
                                        <Clock size={22} className="text-[#7F00FF]" />
                                        Scheduling
                                    </h3>
                                    <div className="flex flex-col md:flex-row gap-8">
                                        <div className="flex-1 space-y-3">
                                            <p className="text-sm font-black text-gray-400 uppercase tracking-widest">Active Days</p>
                                            <div className="flex flex-wrap gap-2">
                                                {Array.isArray(mentor.availableDays) ? mentor.availableDays.map(day => (
                                                    <span key={day} className="px-3 py-1 bg-purple-50 text-[#7F00FF] font-bold rounded-lg text-xs uppercase letter-spacing-wide">
                                                        {day.substring(0, 3)}
                                                    </span>
                                                )) : <span className="text-gray-500 font-medium italic">Refer to plan for details</span>}
                                            </div>
                                        </div>
                                        <div className="flex-1 space-y-3">
                                            <p className="text-sm font-black text-gray-400 uppercase tracking-widest">Time Slot Preference</p>
                                            <div className="text-gray-700 font-bold flex items-center gap-2">
                                                <Clock size={16} />
                                                {mentor.preferredTime && mentor.preferredTime.length > 0 
                                ...
                                <section className="space-y-6">
                                    <div className="flex items-center justify-between px-2">
                                        <h3 className="text-2xl font-black text-gray-900">Mentees Feedback</h3>
                                        <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-2xl shadow-sm border border-gray-100">
                                            <Star className="fill-yellow-400 text-yellow-400" size={20} />
                                            <span className="font-black text-gray-900">{mentor.rating?.toFixed(1) || '5.0'}</span>
                                            <span className="text-gray-300 font-bold">({reviews.length})</span>
                                        </div>
                                    </div>
                                    ...
                                    {reviews.length > 0 ? (
                                        <div className="grid grid-cols-1 gap-4">
                                            {reviews.map((review) => (
                                                <div key={review._id} className="bg-white rounded-[2rem] p-8 shadow-xl shadow-gray-200/50 border border-gray-100">
                                                    <div className="flex justify-between items-start mb-6">
                                                        <div className="flex items-center gap-4">
                                                            <img 
                                                                src={review.userId?.profilePic || `https://ui-avatars.com/api/?name=${encodeURIComponent(review.userId?.name || 'User')}&background=F3E8FF&color=7F00FF&bold=true`}
                                                                alt={review.userId?.name}
                                                                className="w-14 h-14 rounded-2xl object-cover"
                                                            />
                                                            <div>
                                                                <h4 className="font-black text-gray-900">{review.userId?.name || 'Anonymous User'}</h4>
                                                                <p className="text-xs text-gray-400 font-bold uppercase tracking-widest">Verified Student</p>
                                                            </div>
                                                        </div>
                                        ...
                                        <div className="bg-white rounded-[2rem] p-12 shadow-xl shadow-gray-200/50 border border-gray-100 text-center">
                                            ...
                                            <h4 className="text-xl font-black text-gray-900 mb-2">New Talent Detected!</h4>
                                            <p className="text-gray-500 font-medium max-w-sm mx-auto">
                                                This mentor is new to our platform. Be the first to start a journey with them and shape the future!
                                            </p>
                                        </div>
                                    )}
                                </section>
