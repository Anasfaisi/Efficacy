                        ...
                        notifications.slice(0, 10).map((notif) => (
                            ...
                            >
                                <div className="flex gap-3">
                                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 ${notif.type?.includes('mentorship') ? "bg-purple-100 text-[#7F00FF]" : "bg-blue-100 text-blue-600"}`}>
                                        <Bell size={14} />
                                    </div>
