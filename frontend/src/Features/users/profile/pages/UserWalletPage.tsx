                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                        <div>
                            ...
                            <p className="text-slate-500 font-medium">
                                Manage your balance, transactions, and bank
                                details
                            </p>
                        </div>
                                ...
                                {hasBankDetails && !showBankForm ? (
                                    <div className="space-y-4">
                                        <div className="p-4 bg-purple-50 rounded-2xl border border-purple-100 relative overflow-hidden group">
                                            ...
                                            <CheckCircle2
                                                size={40}
                                                className="absolute -right-4 -bottom-4 text-purple-200/40 rotate-12 group-hover:scale-110 transition-transform"
                                            />
                                        </div>
