                ...
                <div className="min-w-[900px]">
                    ...
                    <div className="sticky top-0 z-20 flex bg-white/95 backdrop-blur-sm border-b border-gray-100 shadow-sm h-28">
                        ...
                        {weekDays.map((day) => {
                            ...
                            return (
                                <div
                                    key={day.toISOString()}
                                    className="flex-1 border-r border-gray-100 flex flex-col items-center justify-center group"
                                >
                                    <p
                                        className={cn(
                    ...
                    <div className="flex relative">
                        ...
                        {weekDays.map((day) => (
                            <div
                                key={day.toISOString()}
                                className="flex-1 border-r border-gray-100 relative min-h-[1536px] group/col"
                            >
                                {/* Hour Slots */}
                                {HOURS.map((hour) => (
                                    <div
