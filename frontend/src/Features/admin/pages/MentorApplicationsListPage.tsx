...
import { Search, Loader2, User, Mail, ChevronRight, BadgeCheck, Clock } from 'lucide-react';
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Mentor Applications</h1>
                    <p className="text-gray-500 text-sm mt-1">Review and manage incoming mentor applications</p>
                </div>
            ...
            {loading ? (
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-12 text-center shadow-sm">
                    ...
                    <p className="text-gray-500 mt-1 max-w-sm mx-auto">There are currently no mentor applications pending review or matching your search.</p>
                </div>
            ) : (
                <div className="grid gap-4">
                    {filteredApplications.map((app) => (
                        <div 
                            key={app._id} 
                            onClick={() => navigate(`/admin/mentors/review/${app.id}`)}
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="space-y-1">
                                    <div className="flex items-center gap-2">
                                        <h3 className="font-bold text-gray-900 text-lg tracking-tight">{app.name}</h3>
                                        <span className={cn(
