...
const MentorWalletPage: React.FC = () => {
        ...
        if (success === 'true') {
            const verifyStatus = async () => {
                const toastId = toast.loading(
                    'Verifying Stripe Connect status...'
                );
                try {
                    ...
                    if (status.onboarded) {
                        toast.success(
                            'Successfully onboarded with Stripe Connect!'
                        );
                    } else {
                        toast.error(
                    ...
                    toast.dismiss(toastId);
                    console.error(
                        'Failed to verify Stripe Connect status:',
                        error
                    );
            ...
            toast.info(
                'Onboarding was interrupted. Please try connecting your account again.'
            );
            const newUrl = window.location.pathname;
            window.history.replaceState({}, document.title, newUrl);
        }
    ...
    const handleWithdraw = async () => {
        ...
        try {
            ...
            toast.success(
                'Withdrawal request submitted successfully! Funds will clear in 24-48h.'
            );
            setWithdrawAmount('');
            ...
            <div className="flex justify-center items-center h-96">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-zinc-500 font-semibold text-sm animate-pulse">
                        Loading secure payout dashboard...
                    </p>
                </div>
            </div>
        );
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-zinc-500 font-medium text-sm mt-1">
                        Manage your mentorship balances, bank details, and
                        withdraw cleared earnings.
                    </p>
                </div>
                    ...
                    <div className="relative z-10 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                        <div className="max-w-2xl space-y-2">
                            ...
                            <p className="text-violet-100 text-sm font-medium leading-relaxed">
                                Avoid manual withdrawals entirely. Connect your
                                account via Stripe Connect to transfer earnings
                                directly to your bank account within minutes of
                                session completion.
                            </p>
                        </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="font-black text-emerald-950 text-sm">
                                Stripe Automated Payouts Connected
                            </h3>
                            <p className="text-emerald-700 text-xs font-semibold">
                                Connected to account{' '}
                                {wallet?.stripeConnectAccountId}. Payouts will
                    ...
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <div className="flex items-baseline mt-2 text-zinc-900">
                                <span className="text-xl font-bold text-zinc-500 mr-0.5">
                                    ₹
                                </span>
                                ...
                                >
                                    ...
                                    {showTooltip && (
                                        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 w-64 bg-zinc-950 text-white text-[10px] font-medium leading-relaxed p-3 rounded-xl shadow-2xl border border-zinc-800 z-50 animate-in fade-in-20 duration-150">
                                            Funds are temporarily held in secure
                                            Stripe/Platform escrow and
                                            automatically clear to your
                                            available balance 30 days after the
                                            mentorship session.
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="p-4 bg-amber-50 border border-amber-100 rounded-2xl flex items-start gap-2.5 text-xs text-amber-800">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[11px] leading-relaxed mt-0.5">
                                            Please populate your Direct Deposit
                                            details in the main page before
                                            invoking withdrawals.
                                        </p>
                                    </div>
                                </div>
                            )}
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <p className="text-[10px] text-zinc-400 mt-2 font-semibold uppercase flex items-center gap-1">
                                        <Info size={11} /> Minimum withdrawal:
                                        ₹500
                                    </p>
                                </div>
