...
const MentorRegister: React.FC = () => {
    ...
    const onSubmit = async (data: RegisterFormData) => {
        try {
            ...
            if (result.tempEmail) {
                toast.success('Professional account initiated. Verify your email.');
                navigate('/verify-otp');
            }
        } catch (error: unknown) {
                ...
                <div className="md:w-[45%] bg-primary p-12 text-white flex flex-col items-center justify-center relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col items-center gap-8 text-center">
                        ...
                        <div className="space-y-4 max-w-sm">
                            <h3 className="text-2xl font-bold text-slate-700">Empower Global Talent</h3>
                            <p className="leading-relaxed text-sm text-slate-700">
                                Create your professional profile, set your rates, and start mentoring. We handle the platform, you handle the impact.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex-1 p-8 md:p-12 lg:p-16 bg-white overflow-y-auto">
                    <div className="max-w-md mx-auto">
                        <div className="mb-10 text-center md:text-left">
                            <h2 className="text-4xl font-black text-slate-800">Professional Sign Up</h2>
                            <p className="text-slate-500 mt-2">Join the Efficacy expert network.</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                            ...
                            >
                                {isLoading ? <Loader2 className="animate-spin" /> : 'Begin Application'}
                            </button>

                            <p className="text-center text-slate-500 text-sm mt-8">
                                Already a mentor?{' '}
                                <Link to="/mentor/login" className="text-primary font-bold hover:underline">
                                    Log In
                                </Link>
                            </p>
                        </form>
