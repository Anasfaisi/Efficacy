    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 text-center">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-10 border border-slate-100">
        ...
        <p className="text-slate-500 mb-8">
          Thank you for applying to be a mentor. Your application status is
          currently <span className="font-semibold text-sky-600">Pending</span>.
          <br />
          <br />
          Our admin team will review your profile and notify you within 2
          business days.
        </p>
