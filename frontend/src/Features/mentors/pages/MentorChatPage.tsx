        ...
        <div className="flex bg-gray-50 min-h-screen overflow-hidden">
            ...
            <div className="flex-1 flex flex-col h-screen overflow-hidden">
                <div className="flex-1 flex overflow-hidden relative border-t border-gray-200 transition-all duration-300 w-full">
                    ...
                    <div
                        className={`${isSidebarOpen ? 'w-full md:w-80 absolute md:relative z-20 h-full' : 'hidden'} bg-white border-r border-gray-200 flex flex-col transition-all duration-300`}
                    >
                                            ...
                                            >
                                                <div className="relative">
                                                    ...
                                                    >
                                                        ...
                                                        <div
                                                            className={`text-[10px] mt-1 ${isMe ? 'text-purple-200' : 'text-gray-400'} text-right`}
                                                        >
                                                            {new Date(
                                                                msg.createdAt
                                                            ).toLocaleTimeString(
