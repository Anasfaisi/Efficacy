                                            ...
                                            notifications.map((notif) => (
                                                ...
                                                >
                                                    <div className="flex gap-3">
                                                        <div
                                                            className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 ${notif.type === 'mentorship_request' ? 'bg-indigo-100 text-indigo-600' : 'bg-blue-100 text-blue-600'}`}
                                                        >
                                                            <Bell size={14} />
                                                        </div>
                                                        <div>
