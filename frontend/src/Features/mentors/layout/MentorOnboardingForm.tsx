        ...
        if (mentor?.role === 'mentor') {
            ...
            if (status === 'reapply' || status === 'incomplete') {
                ...
                if (mentor.qualification)
                    setValue('qualification', mentor.qualification);
                if (mentor.university)
                    setValue('university', mentor.university);
                if (mentor.graduationYear)
                    setValue('graduationYear', mentor.graduationYear);
                if (mentor.expertise) setValue('expertise', mentor.expertise);
                if (mentor.domain) setValue('domain', mentor.domain);
                if (mentor.academicSpan)
                    setValue('academicSpan', mentor.academicSpan);
                if (mentor.industryCategory)
                    setValue('industryCategory', mentor.industryCategory);
                if (mentor.experienceYears)
                    setValue('experienceYears', mentor.experienceYears);
                if (mentor.currentRole)
                    setValue('currentRole', mentor.currentRole);
                if (mentor.skills) setValue('skills', mentor.skills);
                if (mentor.guidanceAreas)
                    setValue('guidanceAreas', mentor.guidanceAreas);
                if (mentor.experienceSummary)
                    setValue('experienceSummary', mentor.experienceSummary);
            }
        }
                            ...
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div className="flex-1">
                                    <h3 className="text-xl font-bold text-amber-900 mb-2">
                                        ⚠️ Action Required: Changes Needed for
                                        Your Application
                                    </h3>
                                    <div className="bg-white/80 backdrop-blur-sm p-4 rounded-lg border border-amber-200 mb-3">
                                        <p className="text-amber-900 font-medium leading-relaxed whitespace-pre-wrap">
                                            {activeMentor.applicationFeedback ||
                                                "Please review your application and update the necessary details as per the administrator's feedback."}
                                        </p>
                                    </div>
                                    <div className="flex items-center gap-2 text-sm font-semibold text-amber-700">
                                        <CheckCircle size={16} />
                                        <span>
                                            Your previous data has been
                            ...
                            {currentStep === 3 && (
                                <div className="space-y-6">
                                    ...
                                    <p className="text-xs text-gray-500 text-center flex items-start justify-center gap-1">
                                        ...
                                        This document is used for verification
                                        purposes only and will not be shared
                                        publicly.
                                    </p>
                                    ...
                                    <div className="mt-6">
                                        ...
                                        <p className="text-xs text-gray-500 mt-1">
                                            ...
                                            expertise.Please provide either a
                                            shareable Google Drive link or an
                                            unlisted YouTube video or any.
                                        </p>
                                        <ErrorMsg
                                            message={
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="pt-6 border-t border-gray-100">
                                        ...
                                        <p className="mt-2 text-xs text-slate-500 leading-relaxed italic">
                                            Note: During your initial 2 months
                                            or first 10 sessions, your charge is
                                            limited between ₹1500 to ₹2000. This
                                            helps you build a solid foundation
                                            and receive initial ratings. You can
                                            scale your pricing later based on
                                            your performance.
                                        </p>
                                        <ErrorMsg
                                            message={
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        >
                                            ...
                                            <p className="text-gray-500 text-sm">
                                                ...
                                                national-level exams (JEE, NEET,
                                                CAT, etc.), clarify academic
                                                doubts, and suggest effective
                                                learning resources rather than
                                        ...
                                        >
                                            ...
                                            <p className="text-gray-500 text-sm">
                                                ...
                                                professional world. Provide
                                                career guidance, industry
                                                insights, resume reviews, mock
                                                interviews, and share real-world
                                                project experiences from your
                                                corporate journey.
                                            </p>
                                        </div>
                                    </div>
                                    <ErrorMsg
                                        message={errors.mentorType?.message}
                                    />
                                    {watchedMentorType && (
                                        <p className="text-center text-sm text-gray-500 mt-4">
                                            You selected{' '}
                                            <strong>
                                                {watchedMentorType} Monitor
                                            </strong>
                                ...
                                <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                                            ...
                                                            {getValues(
                                                                ...
                                                                (
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        className="px-2 py-1 bg-amber-50 text-amber-700 text-xs rounded-md border border-amber-100"
                                                                    >
                                                                        {area}
                                                                    </span>
                                                                )
                                    ...
                                    <div className="bg-blue-50 border border-blue-100 p-4 rounded-xl flex gap-3 text-blue-800 text-sm shadow-sm mt-4">
                                        ...
                                        <p>
                                            ...
                                            This process usually takes 24-48
                                            hours. You will be notified via
                                            email immediately after the review
                                            process.
                                        </p>
                                    </div>
