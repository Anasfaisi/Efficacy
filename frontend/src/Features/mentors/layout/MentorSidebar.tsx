...
const MentorSidebar: React.FC = () => {
    ...
    useEffect(() => {
        if (
            ...
            location.pathname.startsWith('/mentor/my-sessions')
        ) {
    ...
    const navItems = [
        ...
        },
        {
            ...
            subItems: [
                ...
                { label: 'My Sessions', to: '/mentor/my-sessions' },
            ],
        },
        {
    ...
    return (
        <aside
            className={`sticky top-0 h-screen ${collapsed ? 'w-24' : 'w-72'} bg-white border-r border-gray-200 z-20 hidden lg:flex flex-col transition-all duration-300 shrink-0`}
        >
            {/* Toggle Button */}
            <button
