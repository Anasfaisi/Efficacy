                ...
                >
                    ...
                    <div className="bg-indigo-600 p-6 flex items-center justify-between">
                        <h2 className="text-xl font-bold text-white flex items-center gap-2">
                            <span className="bg-white/20 p-2 rounded-lg">
                                <Calendar className="w-5 h-5 text-indigo-50" />
                            </span>
                            Session Details
                        </h2>
                        <button
                    ...
                    <div className="p-8 space-y-6">
                        ...
                        <div className="flex items-center justify-between px-6 py-4 bg-indigo-50 rounded-2xl border border-indigo-100">
                            <div>
                                <p className="text-xs font-bold text-indigo-400 uppercase mb-1 tracking-wider">
                                    Session Status
                                </p>
                            ...
                            <div className="text-right">
                                ...
                                <p className="font-bold text-indigo-900 truncate max-w-[150px]">
                            ...
                            {loading ? (
                                ...
                                <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100 text-center">
                                    <p className="text-gray-500 font-medium text-sm">
                                        No review submitted for this session
                                        yet.
                                    </p>
                                </div>
                            )}
