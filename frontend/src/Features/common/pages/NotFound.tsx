...
const NotFound: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-mesh flex items-center justify-center p-4">
            ...
            <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-primary/5 rounded-full blur-3xl -z-10 animate-float" style={{ animationDelay: '0s' }} />
            <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-accent/5 rounded-full blur-3xl -z-10 animate-float" style={{ animationDelay: '2s' }} />
        </div>
    );
};
