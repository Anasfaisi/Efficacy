...
const testimonials = [
    {
        ...
        content: 'Efficacy has completely transformed how I study. The Pomodoro timer and task management combined with mentor support is a game-changer.',
        rating: 5
    },
    {
        name: 'Sarah Chen',
        ...
        content: 'I found an amazing mentor through Efficacy who helped me land my first job. The platform is so intuitive and beautiful.',
        rating: 5
    },
    {
        name: 'Michael Smith',
        ...
        content: "The focus music and notes feature help me stay productive during long 12-hour study sessions. I couldn't imagine studying without it.",
        rating: 4
    }
];
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-primary font-bold">{testimonials[activeIndex].role}</p>
                            </div>
                        </motion.div>
                    </AnimatePresence>
                        ...
                        {testimonials.map((_, i) => (
                            <button
                                ...
                                className={`w-3 h-3 rounded-full transition-all duration-300 ${
                                    i === activeIndex ? 'bg-primary w-8' : 'bg-slate-200 hover:bg-slate-300'
                                }`}
                            />
                        ))}
                    </div>
