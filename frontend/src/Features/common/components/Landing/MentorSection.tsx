...
const MentorSection: React.FC = () => {
    return (
        <section id="mentors" className="py-24 bg-gradient-to-br from-primary to-accent relative overflow-hidden bg-blue-900">
            {/* Abstract Shapes */}
                ...
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    <div className="flex-1 text-white text-center lg:text-left">
                        ...
                        <p className="mt-6 text-white/80 text-lg md:text-xl max-w-xl">
                            Join our community of elite mentors. Help the next generation of learners while building your personal brand and earning extra income.
                        </p>
                    ...
                    <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-2xl">
                        {[
                            { icon: <Award className="w-8 h-8" />, title: 'Certified Experts', desc: 'Verified skills and background.' },
                            { icon: <Zap className="w-8 h-8" />, title: 'Direct Impact', desc: 'Help students achieve goals.' },
                            { icon: <Users className="w-8 h-8" />, title: 'Large Community', desc: 'Millions of monthly active users.' },
                            { icon: <CheckCircle2 className="w-8 h-8" />, title: 'Easy Setup', desc: 'Get started in minutes.' }
                        ].map((card, i) => (
                            <motion.div
                                key={i}
