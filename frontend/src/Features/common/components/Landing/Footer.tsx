            ...
            <div className="container mx-auto px-6 md:px-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    <div className="space-y-6">
                        <Link to="/" className="flex items-center gap-2">
                            ...
                            <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent">Efficacy</span>
                        </Link>
                        <p className="text-slate-500 leading-relaxed">
                            The ultimate productivity and mentorship platform for students who want to build consistency and achieve their dreams.
                        </p>
                    ...
                    <div>
                        <h4 className="text-slate-900 font-bold text-lg mb-6">Platform</h4>
                        <ul className="space-y-4">
                            {['Features', 'Pricing', 'How it Works', 'Mentors', 'Community'].map((link) => (
                                <li key={link}>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            {['About Us', 'Contact', 'Privacy Policy', 'Terms of Service', 'Careers'].map((link) => (
                                <li key={link}>
                                    <a href="#" className="hover:text-primary transition-colors">{link}</a>
                                </li>
                            ))}
                    ...
                    <div>
                        <h4 className="text-slate-900 font-bold text-lg mb-6">Newsletter</h4>
                        <p className="text-slate-500 mb-6 font-medium">Get the latest productivity tips and updates.</p>
                ...
                <div className="pt-12 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-6 text-slate-500">
                    ...
                    <p className="flex items-center gap-2">
                        Built with <Heart className="w-4 h-4 text-red-500 fill-red-500" /> for lifelong learners.
                    </p>
                </div>
            </div>
        </footer>
