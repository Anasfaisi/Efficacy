...
const steps = [
    {
        ...
        title: 'Plan',
        description: 'Organize your schedule, tasks, and deadlines in one place.',
        color: 'from-blue-400 to-primary'
    },
    {
        icon: <Focus className="w-8 h-8" />,
        title: 'Focus',
        description: 'Stay in the zone with our customizable Pomodoro timer and focus music.',
        color: 'from-primary to-purple-500'
    },
    {
        icon: <Edit3 className="w-8 h-8" />,
        title: 'Capture',
        description: 'Take structured notes and organize them for easy retrieval later.',
        color: 'from-purple-500 to-accent'
    },
    {
        icon: <HeartHandshake className="w-8 h-8" />,
        title: 'Get Guidance',
        description: 'Connect with expert mentors to overcome hurdles and accelerate learning.',
                        ...
                        {steps.map((step, index) => (
                            ...
                            >
                                <div className="bg-white p-8 rounded-3xl shadow-soft border border-slate-100 h-full flex flex-col items-center text-center transition-all duration-300 group-hover:border-primary/30 group-hover:shadow-xl group-hover:shadow-primary/5">
                                    <div className={`w-16 h-16 mb-6 rounded-2xl bg-gradient-to-br ${step.color} flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                                        {step.icon}
                                    </div>
