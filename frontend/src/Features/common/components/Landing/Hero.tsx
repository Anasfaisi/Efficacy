                ...
                <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
                    <div className="flex-1 text-center md:text-left">
                        ...
                        >
                            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-slate-900 leading-tight">
                                Build Focus. <br />
                                Plan Smarter. <br />
                                <span className="gradient-text">Learn with the Right Mentor.</span>
                            </h1>
                            <p className="mt-6 text-lg md:text-xl text-slate-600 max-w-2xl mx-auto md:mx-0">
                                Efficacy is your all-in-one productivity and mentorship platform designed to help students and self-learners master their time and reach their goals.
                            </p>
                    ...
                    <div className="flex-1 relative">
                        ...
                        >
                            ...
                            <div>
                                <p className="text-base font-bold text-slate-800">Tasks Completed</p>
                                <p className="text-xs text-slate-500">12 today • +20%</p>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div>
                                <p className="text-base font-bold text-slate-800">Deep Work</p>
                                <p className="text-xs text-slate-500">2h 45m session</p>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div>
                                <p className="text-base font-bold text-slate-800">New Notes</p>
                                <p className="text-xs text-slate-500">Physics Module 3</p>
                            </div>
                        </motion.div>
                    </div>
                </div>
