...
import type { MentorApplication } from '../Features/admin/types';
...
export const adminService = {
    ...
    rejectMentorApplication: async (id: string, reason: string): Promise<void> => {
        await api.post(`/admin/mentors/applications/${id}/reject`, { reason });
    },

    requestChangesMentorApplication: async (id: string, reason: string): Promise<void> => {
        await api.post(`/admin/mentors/applications/${id}/request-changes`, { reason });
    },
