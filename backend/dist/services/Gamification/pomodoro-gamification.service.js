...
exports.PomodoroGamificationService = void 0;
...
let PomodoroGamificationService = class PomodoroGamificationService {
    _userStatsRepo;
    _dailyStreakCalc;
    _badgeGamificationService;
    constructor(_userStatsRepo, _dailyStreakCalc, _badgeGamificationService) {
        this._userStatsRepo = _userStatsRepo;
        this._dailyStreakCalc = _dailyStreakCalc;
        this._badgeGamificationService = _badgeGamificationService;
    }
    async handlePomodoroCompletion(event, userId) {
        ...
        const savedStats = await this._userStatsRepo.UpdateUserStats(streakUpdate.id, streakUpdate);
        if (!savedStats)
...
exports.PomodoroGamificationService = PomodoroGamificationService;
exports.PomodoroGamificationService = PomodoroGamificationService = __decorate([
...
], PomodoroGamificationService);
//# sourceMappingURL=pomodoro-gamification.service.js.map