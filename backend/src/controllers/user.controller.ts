...
import { ForgotPasswordRequestDto, LoginRequestDto, OtpVerificationRequestDto, RefreshRequestDto, RegisterRequestDto, resendOtpRequestDto, ResetPasswordrequestDto } from "@/Dto/requestDto";
...
export class UserController {
  ...
  async resendOtp(req: Request, res: Response) {
    try {
      ...
      const { tempEmail: userEmail } = await this._authService.resendOtp(dto.email);
